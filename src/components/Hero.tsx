...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-48 h-48 bg-gradient-glow rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-lg">
              Connect screen owners with advertisers. Upload content, schedule broadcasts, 
              and monetize digital displays worldwide with Red Square.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
              <Button 
                size="lg" 
                className="bg-gradient-primary hover:shadow-[var(--shadow-red)] transition-all duration-300 animate-glow-pulse"
              >
          ...
          <div className="relative">
            <div className="relative group">
              <img 
                src={heroImage} 
                alt="Digital screen displaying content" 
